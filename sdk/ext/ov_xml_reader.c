...
static int ov_xml_reader_init(ov_xml_reader_object* self, PyObject* args,
  ...
  if (read == NULL) {
    ...
    PyErr_Format(PyExc_TypeError,
                 "The 'io' parameter doesn't look like an IO object, doesn't "
                 "have a 'read' method");
    return -1;
  }
  Py_DECREF(read);
...
#ifdef Py_mod_exec
int ov_xml_reader_define(PyObject* module) {
#else
...
#ifdef Py_mod_exec
  PyModule_AddObject(module, "XmlReader", (PyObject*)&ov_xml_reader_type);
  return 0;
#else
